            ...
            <div class="box box-primary">
                <div class="box-header">   
                    <ul class="nav nav-tabs">
                        ...
                        <li class="pull-right"><a href="<?php echo site_url('printer'); ?>" class="text-muted"><i class="fa fa-remove"></i></a></li>
                    </ul>
                                ...
                                foreach ($history as $s) {
                                  echo"
                                    <tr>                                     
                                      ...
                                      <td>".$s->note."</td>  
                                      <td>" . anchor('printer/edithistory/' . $s->id_history, '<i class="btn glyphicon glyphicon-edit" data-toggle="tooltip" title="Edit"></i>')."<a href=".base_url('printer/print_history/'.$s->id_history)." target='_blank' ><i class='btn fa fa-print' data-toggle='tooltip' title='Print'></i></td>                                     
                                    </tr> ";
                                }
                             ?>                      
                          </table>
