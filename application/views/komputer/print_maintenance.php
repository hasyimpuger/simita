...
<table width="615" >
  <tr>
    ...
    <div align="center" class="title">KARTU KOMPUTER</div></strong></u></td>    
  </tr>
 <tr>
  ...
  <tr>
    <td id="noBorder"><table width="436" height="125" cellspacing="0" cellpadding="0" >
      <tr>
        ...
        <td width="297" id="noBorder"><?php echo $recordall['kode_komputer']; ?></td>
      </tr>
      <tr>
        <td id="noBorder">Nama / Manufacture</td>
        <td id="noBorder">:</td>
        <td id="noBorder"><?php echo $recordall['nama_komputer']; ?> </td>
      </tr>
      <tr>
