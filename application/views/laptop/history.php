...
<section class="content-header">
    <h1>
        Tambah
        <small>Mutasi Inventaris Laptop</small>
    </h1>
    <ol class="breadcrumb">
                        ...
                        <div class="form-group">                                                
                          ...
                          <br>
                            <tr>
                              ...
                              <input type="hidden"  name="no_inv" value="<?php echo $recordall['kode_laptop'] ?>" >
                            ...
                            <tr>
                              ...
                              <input type="hidden"  name="no_inv" value="<?php echo $recordall['aset_hrd'] ?>" >
                              <input type="hidden"  name="pengguna_awal" value="<?php echo $recordall['id_pengguna'] ?>" >
                            </tr>
                            <tr>
