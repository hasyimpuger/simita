...
class M_komputer extends CI_Model {    
    ...
    function semua() {        
        $query = $this->db->query("SELECT tb_inv_komputer.id_komputer,tb_inv_komputer.kode_komputer,tb_pengguna.nama_pengguna,tb_departemen.id_dept,tb_cabang.namacabang,
            ...
            INNER JOIN tb_cabang ON tb_pengguna.id_cabang = tb_cabang.id_cabang
