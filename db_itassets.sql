...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2018 at 11:01 AM
...
(8, 'LAP-JKT-18003', '2018-10-18 05:52:19', 'Buat Baru', 'Ahmad Sopian', 'U018.0003', 'U018.0003', '', 'Inventory Baru'),
(9, 'LAP-JKT-18004', '2018-10-18 05:53:26', 'Buat Baru', 'Ahmad Sopian', 'U018.0005', 'U018.0005', '', 'Inventory Baru'),
(10, 'CPU-JKT-18003', '2018-10-26 09:49:12', 'Buat Baru', 'Ahmad Sopian', 'U018.0003', 'U018.0003', '', 'Inventory Baru'),
(11, 'CPU-JKT-18003', '2018-10-26 09:50:14', 'Buat Baru', 'Ahmad Sopian', 'U018.0003', 'U018.0003', '', 'Inventory Baru'),
(12, 'CPU-JKT-18004', '2018-10-26 10:42:51', 'Buat Baru', 'Ahmad Sopian', 'U018.0003', 'U018.0003', '', 'Inventory Baru');
...
INSERT INTO `tb_inv_printer` (`id_printer`, `kode_printer`, `aset_hrd`, `id_pengguna`, `jenis_printer`, `spesifikasi`, `tgl_inv`, `harga_beli`, `status`, `note`, `createby`, `createdate`, `updateby`, `updatedate`, `gid`) VALUES
(1, 'PRI-JKT-18001', 'BITJ97/2/3/8/723/8', 'U018.0003', 'DESKJET', 'TEST', '2018-06-12', '200000', 'DIGUNAKAN', NULL, NULL, NULL, NULL, NULL, 1);
...
INSERT INTO `tb_lisensi` (`id_lisensi`, `kode_lisensi`, `id_supplier`, `jenis_lisensi`, `id_cabang`, `key_lisensi`, `tgl_pembelian`, `tgl_habis`, `jumlah_lisensi`, `jumlah_terpakai`, `keterangan`, `createby`, `createdate`, `updateby`, `updatedate`, `gid`) VALUES
(1, 'LIC-JKT-09.001', '16', 'AntiVirus', '17', '123AGBJSA', '2018-09-22', '2019-09-22', '10', NULL, '<p>asas</p>', 'root', '2018-09-22 00:00:00', NULL, NULL, '1'),
(2, 'LIC-JKT-09.001', '17', 'AntiVirus', '1', 'ABCDEFG123', '2018-09-22', '2018-09-22', '20', NULL, '<p>asasa</p>', 'root', '2018-09-22 18:20:43', NULL, NULL, '1'),
(3, 'LIC-JKT-0918001', '17', 'AntiVirus', '13', '1298298192', '2018-09-22', '2018-09-26', '10', NULL, '<p>asas</p>', 'root', '2018-09-22 18:29:42', NULL, NULL, '1'),
(4, 'LIC-JKT-0918001', '16', 'Office', '16', '1298298192', '2018-09-23', '2018-10-07', '11', NULL, '<p>asas</p>', 'root', '2018-09-22 18:30:21', NULL, NULL, '1');
...
(38, 'Mikrotik & Lainnya', 'fa fa-unlock-alt', 'password', 36, 'Admin', 'Y'),
...
(8, 'Ahmad Sopian', 'root', '59520785981ac5a0b12fc284f01c301e8c7708fb', 'Administrator', '2018-10-26 09:44:29', 1, NULL, NULL),
...
--
ALTER TABLE `tb_inv_laptop`
  MODIFY `id_laptop` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tb_manufacture`
  MODIFY `id_manufacture` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_trans_detail`
  MODIFY `id_trans_detail` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `tb_trans_keluar`
--
ALTER TABLE `tb_trans_keluar`
  MODIFY `id_transaksi` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
